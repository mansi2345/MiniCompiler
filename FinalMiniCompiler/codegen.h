...
{
public:
    llvm::LLVMContext llvmContext;        // handle the global state
    llvm::IRBuilder<> builder;            // makes it easy to emit instruction
    std::unique_ptr<llvm::Module> module; // hold the functions and variables like a translation unit
